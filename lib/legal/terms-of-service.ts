export const termsOfService = {
  ...
  content: {
    ...
    payment: {
      ...
      sections: [
        {
          title: '2.1 Payment Schedule',
          text: 'We require 50% of the total project fee upfront as a deposit before commencing work. The remaining balance is due upon project completion or delivery of agreed milestones.'
        },
        {
          title: '2.2 Payment Methods',
          text: 'Payments can be made via bank transfer or other methods agreed upon during the proposal stage.'
        },
        {
          title: '2.3 Late Payments',
          text: 'Invoices not paid within the agreed timeframe may incur a late payment fee of 5% per month.'
        }
      ]
    },
    intellectualProperty: {
      ...
      sections: [
        ...
        },
        {
          ...
          text: 'Upon full payment, the client receives a non-exclusive, perpetual license to use the deliverables for the intended purpose as outlined in the contract.'
        },
        {
    ...
    termination: {
      title: '5. Termination and Refunds',
      sections: [
        {
    ...
    disputeResolution: {
      ...
      text: 'These terms are governed by the laws of Germany. Any disputes arising from this agreement will be resolved through mediation before escalating to formal legal proceedings.'
    },
    contact: {
