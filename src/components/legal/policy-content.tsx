...
export function PolicyContent() {
    const {closePolicy, policyType} = usePolicy();
    ...
    const title = policyType === 'privacy' ? 'Privacy Policy' :
    ...
    return (
        ...
        >
            <div
                className="fixed inset-x-4 top-4 bottom-4 md:inset-x-auto md:left-1/2 md:-translate-x-1/2 md:w-[640px] lg:w-[800px]">
                <div className="h-full bg-card rounded-lg shadow-lg border flex flex-col">
                    <div className="flex items-center justify-between p-6 border-b">
                        <h2 className="text-2xl font-semibold">{title}</h2>
                        <Button variant="ghost" size="icon" onClick={closePolicy}>
                            ×
                        </Button>
                    </div>
                    ...
                    <ScrollArea className="flex-1 p-6">
                        <div className="prose prose-sm dark:prose-invert max-w-none">
                            ...
                            {Object.entries(content.content).map(([key, section]) => (
                    ...
                    <div className="p-6 border-t">
                        <Button onClick={closePolicy} className="w-full">
                            Close
                        </Button>
                    </div>
                </div>
